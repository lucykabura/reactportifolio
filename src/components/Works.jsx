        ...
        {projects.map((p, index) => (
          ...
          >
            ...
            <div className=" w-full h-[100px] bg-white dark:bg-[#04133e] ">
              ...
              <a href="https://docs.google.com/presentation/d/1QRhTqcHFaNTL6Q5HB2PrmGLTZ0q-HNYx/edit?usp=drivesdk&ouid=100570993931120722773&rtpof=true&sd=true">
              <p className=' text-white text-sm'>{p.url}</p>
              </a>
            </div>
          </div>
        ))}
