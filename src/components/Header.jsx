...
import portfolioImage from '../assets/work/d.png';
    ...
    <div className="w-full flex flex-col lg:flex-row px-8 md:px-10 gap-10 2xl:gap-20 py-20">
      ...
      >
        ...
        <div className=" mt-10 flex gap-10">
          ...
          <a href="https://docs.google.com/document/d/1fMbU1nljD33ppQjF-wT7dTXdyxxBfM4j/edit?usp=share_link&ouid=100570993931120722773&rtpof=true&sd=true">
      ...
      <div className="w-[320px] h-[320px] md:w-[400px] md:h-[400px] 2xl:w-[500px] 2xl:h-[500px] rounded-full border border-gray-600 dark:border-gray-200 relative md:mt-20 lg:mt-0 flex items-center justify-center">
        ...
        data-aos-duration='1000'
        data-aos-easing='ease-in-out'>
          <img src={portfolioImage} alt="Portfolio" className="w-[400px] h-[400px] md:w-[400px] md:h-[400px] 2xl:w-[500px] 2xl:h-[500px] rounded-full border border-gray-600 dark:border-gray-200 relative md:mt-20 lg:mt-0" />
          <img alt="" src={Reactjs}
