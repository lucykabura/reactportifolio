    ...
    <div className='px-0 2xl:px-40'>
        <div className='w-full items-center justify-between py-4 px-10'>
            <div className='flex items-center justify-between w-full'>
                <a href='/' className='text-2xl font-bold text-blue-500 cursor-pointer '>Lucy Muguku</a>
            ...
            id='mobile-menu'>
                <div className='flex flex-col gap-4 text-md text-gray-700 dark:text-neutral-200'>
                    ...
                    <a href='#education' onClick={toggleMenu} className='cursor-pointer'>Education</a>
                    <a href='#experience' onClick={toggleMenu} className='cursor-pointer'>Experience</a>
                    <a href='#skills' onClick={toggleMenu} className='cursor-pointer'>Skills</a>
